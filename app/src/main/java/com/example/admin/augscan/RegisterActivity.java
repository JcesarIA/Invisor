...
//        editTextPhone = findViewById(R.id.edit_text_phone);
    ...
    private void registerUser() {
        ...
        if (email.isEmpty()) {
            editTextEmail.setError("Esta vazio");
            editTextEmail.requestFocus();
            return;
        }
        if (name.isEmpty()) {
            editTextName.setError("Esta vazio");
        ...
        if (password.isEmpty()) {
            editTextPassword.setError("esta vazia");
        ...
        if(!password.equals(cpassword)){
            editTextcPassword.setError("As senhas não são iguas");
                            ...
                            FirebaseDatabase.getInstance().getReference("Users")
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(RegisterActivity.this, "Registrado com sucesso", Toast.LENGTH_LONG).show();
