...
public class deleteItemsActivity extends AppCompatActivity {
    ...
    public void deletefrmdatabase()
    {
        ...
        if(!TextUtils.isEmpty(deletebarcodevalue)){
            ...
            Toast.makeText(deleteItemsActivity.this,"Item Deletado",Toast.LENGTH_SHORT).show();
        }
        else{
            Toast.makeText(deleteItemsActivity.this,"Por favor escaneie o qrcode",Toast.LENGTH_SHORT).show();
        }
    }
}
